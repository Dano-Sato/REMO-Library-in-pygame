...
class textButton(rectObj):
    ...
    def __init__(self,text="",rect=pygame.Rect(0,0,0,0),*,edge=1,font="BMDOHYEON_ttf.ttf",size=None,color=Cs.tiffanyBlue,func=lambda:None,hoverMode=True,fontColor=Cs.white,alpha=200,ralpha=255):
        if size==None:
